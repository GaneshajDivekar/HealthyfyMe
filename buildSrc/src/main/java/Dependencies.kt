...
object Versions {
    ...
    const val coroutinsVersion="1.3.2"
    const val gsonFactory = "2.4.0"
    const val coroutins = "0.9.2"
...
object Libraries {
    ...
    const val coroutinsModel="org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.coroutinsVersion}"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Versions.coroutinsVersion}"
    const val GsonFactory="com.squareup.retrofit2:converter-gson:${Versions.gsonFactory}"
    const val coroutons  ="com.jakewharton.retrofit:retrofit2-kotlin-coroutines-adapter:${Versions.coroutins}"
}
